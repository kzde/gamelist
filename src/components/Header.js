...
import { colorPalettes, headerHeight, textSizes, margins, themeColors } from '../utils/styleUtils';
  ...
  render() {
    return (
      <Wrapper>
        ...
        <Translate>
          <Lang selected={this.state.selectedLanguage === 'en'} onClick={() => this.handleChangeLanguage('en')}>En</Lang>
          <Lang selected={this.state.selectedLanguage === 'fr'} onClick={() => this.handleChangeLanguage('fr')}>Fr</Lang>
        </Translate>
      </Wrapper>
    )
  }
