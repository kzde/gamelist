...
const Lang = styled.span`
  ...
  color: ${props => (props.selected ? `${themeColors.selected}` : `${colorPalettes.white}`)};
  & + span:before {
    content: '|';
